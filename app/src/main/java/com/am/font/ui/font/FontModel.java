 ...
 * Model
 */
class FontModel extends MVPModel<FontPresenter> implements FontDataAdapter, FontJob.Callback {
    ...
    public String getCommonTitle() {
        return ApplicationHolder.getApplicationContext().getString(R.string.font_common);
    }
