 ...
 * Model
 */
class OpenTypeModel extends MVPModel<OpenTypePresenter> implements OpenTypeDataAdapter,
    ...
    public String getItemInfo(Object item) {
        ...
        if (item instanceof TableRecord && mFont != null) {
            ...
            return table == null ? ApplicationHolder.getApplicationContext().getString(
